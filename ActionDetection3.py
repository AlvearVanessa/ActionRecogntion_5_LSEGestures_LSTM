...
# azul rey (245,117,16), azul clarito (117,245,16), naranja (16,117,245)
colors = [(51, 153, 255), (117, 245, 16), (16, 117, 245), (102, 255, 255), (255, 51, 255)]

def prob_viz(res, actions, input_frame, colors):
    output_frame = input_frame.copy()
    for num, prob in enumerate(res):
        cv2.rectangle(output_frame, (0, 60+num*40), (int(prob*100), 90+num*40), colors[num], -1)
        cv2.putText(output_frame, actions[num], (0, 85+num*40), cv2.FONT_HERSHEY_SIMPLEX, 1, (245, 117, 16), 2, cv2.LINE_AA)
